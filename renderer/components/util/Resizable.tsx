...
function Resizable({ dimensions, setDimensions, position, children }) {
  ...
  const isDragging = useCallback(
    () => isDraggingRight || isDraggingLeft || isDraggingTop || isDraggingBottom,
    [isDraggingRight, isDraggingLeft, isDraggingTop, isDraggingBottom]
  )
  const mouseDownRight = useCallback(
    (e: MouseEvent) => {
      e.preventDefault()
      e.stopPropagation()
  ...
  const mouseDownLeft = useCallback(
    (e: MouseEvent) => {
      e.preventDefault()
      e.stopPropagation()
  ...
  const mouseDownTop = useCallback(
    (e: MouseEvent) => {
      e.preventDefault()
      e.stopPropagation()
  ...
  const mouseDownBottom = useCallback(
    (e: MouseEvent) => {
      e.preventDefault()
      e.stopPropagation()
  ...
  const mouseDownTopRight = useCallback(
    (e: MouseEvent) => {
      e.preventDefault()
      e.stopPropagation()
      setIsDraggingTop(true)
  ...
  const mouseDownTopLeft = useCallback(
    (e: MouseEvent) => {
      e.preventDefault()
      e.stopPropagation()
      setIsDraggingTop(true)
  ...
  const mouseDownBottomRight = useCallback(
    (e: MouseEvent) => {
      e.preventDefault()
      e.stopPropagation()
      setIsDraggingBottom(true)
  ...
  const mouseDownBottomLeft = useCallback(
    (e: MouseEvent) => {
      e.preventDefault()
      e.stopPropagation()
      setIsDraggingBottom(true)
  ...
  return (
    <div>
      <div style={handles} className="absolute">
        <div className="float-left w-[10%] h-2 hover:cursor-nw-resize" onMouseDown={mouseDownTopLeft}></div>
        <div className="float-left w-[80%] h-2 hover:cursor-n-resize" onMouseDown={mouseDownTop}></div>
        <div className="float-right w-[10%] h-2 hover:cursor-ne-resize" onMouseDown={mouseDownTopRight}></div>
        <div className="clear-both"></div>
        <div style={middle} className="float-left hover:cursor-w-resize" onMouseDown={mouseDownLeft}></div>
        <div style={middle} className="float-right hover:cursor-e-resize" onMouseDown={mouseDownRight}></div>
        <div className="clear-both"></div>
        <div className="float-left w-[10%] h-2 hover:cursor-sw-resize" onMouseDown={mouseDownBottomLeft}></div>
        <div className="float-left w-[80%] h-2 hover:cursor-s-resize" onMouseDown={mouseDownBottom}></div>
        <div className="float-right w-[10%] h-2 hover:cursor-se-resize" onMouseDown={mouseDownBottomRight}></div>
      </div>
      <div style={handles} className="overflow-hidden">
        {children}
      </div>
    </div>
  )
